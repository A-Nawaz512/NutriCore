...
const Button: FC<ButtonProps> = ({
  ...
  const variantClasses = clsx({
    "bg-blue-800 text-white hover:bg-blue-700 focus:ring-blue-500 cursor-pointer": variant === "primary",
    "bg-gray-100 text-gray-900 hover:bg-gray-200 focus:ring-gray-400 cursor-pointer": variant === "secondary",
    "border-2 border-blue-800 text-blue-800 hover:text-white cursor-pointer hover:bg-blue-800 focus:ring-blue-500": variant === "outline"
  })
