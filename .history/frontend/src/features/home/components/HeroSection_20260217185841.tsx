    ...
    <section className="relative w-full h-[80vh] sm:h-[60vh] overflow-hidden">
      <Swiper
        ...
        pagination={{
          clickable: true,
          bulletClass:
            "swiper-pagination-bullet w-3 h-3 bg-white/50 rounded-full mx-2 transition-all duration-300",
        ...
        {slides.map((slide, index) => (
          <SwiperSlide key={index}>
            ...
            >
              ...
              {/* Text Card */}
              <motion.div
                className="relative z-10 bg-black/60 p-6 md:p-8 rounded-lg max-w-md text-center md:text-left"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.2 }}
              >
                <motion.h2
                  className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-snug text-white"
