...
const SignUpPage: FC = () => {
    ...
    return (
        <div className="min-h-screen flex">
            {/* LEFT BRAND SECTION */}
            <div className="hidden lg:flex w-1/2 bg-gray-800 text-white flex-col justify-center items-center p-0 relative">
                ...
                <div className="hidden lg:flex w-full relative text-white overflow-hidden">
                    ...
                    {/* Dark Green Overlay */}
                    <div className="absolute inset-0 bg-[#25492D]/40" />
