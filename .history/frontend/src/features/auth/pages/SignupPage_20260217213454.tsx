...
const SignUpPage: FC = () => {
    ...
    return (
        <div className="min-h-screen flex">
            {/* LEFT BRAND SECTION */}
            <div className="hidden lg:flex w-1/2 bg-[#25492D] text-white flex-col justify-center items-center p-2 relative">
                <div className="absolute inset-2 bg-gradient-to-br from-[#25492D] to-[#1b3421] opacity-10" />

                {/* LEFT BRAND SECTION */}
                <div className="hidden lg:flex w-full relative text-white overflow-hidden">
