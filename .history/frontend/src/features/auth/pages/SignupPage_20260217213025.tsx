...
const SignUpPage: FC = () => {
    ...
    return (
        <div className="min-h-screen flex">
            {/* LEFT BRAND SECTION */}
            <div className="hidden lg:flex w-1/2 bg-[#25492D] text-white flex-col justify-center items-center p-16 relative">
                <div className="absolute inset-0 bg-gradient-to-br from-[#25492D] to-[#1b3421] opacity-90" />

                <div className="hidden lg:flex w-full relative text-white">
                    ...
                    {/* Green Overlay */}
                    <div className="absolute inset-0 bg-[#25492D]/1 backdrop-blur-sm" />

                    {/* Content */}
                    <div className="relative z-10 max-w-md p-16 flex flex-col justify-center">
                        ...
                        <div className="mt-10 space-y-4">
                            <div className="flex items-center gap-3">
                                <span className="bg-white/20 p-2 rounded-md backdrop-blur">
                                    ✔
                                </span>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span>Expert Health Support</span>
                            </div>
                        </div>
                    </div>
                </div>
