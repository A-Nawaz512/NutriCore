                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {formData.ingredients.map((ing, i) => (
                                    <span key={i} className="inline-flex items-center gap-1 px-3 py-1 bg-greeb-50 text-greeb-700 rounded-full text-sm">
                            ...
                            {[15, 30, 60, 120].map(qty => (
                                <div
                                    ...
                                    className={`border rounded-lg p-3 text-center cursor-pointer transition-all ${formData.supplementQuantityOptions.includes(qty)
                                            ? "border-[#13458A] bg-greeb-50 text-[#13458A] font-medium ring-1 ring-[#13458A]"
