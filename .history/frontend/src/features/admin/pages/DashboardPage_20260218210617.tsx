    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          <select className="bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#13458A]/20">
            <option>Last 7 Days</option>
            <option>Last 30 Days</option>
            <option>This Month</option>
          </select>
          <button className="bg-[#13458A] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#0f366e] transition-colors shadow-sm flex items-center gap-2">
              ...
              <AreaChart data={revenueData}>
                <defs>
                  <linearGradient id="colorRevenue" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#13458A" stopOpacity={0.1} />
                    <stop offset="95%" stopColor="#13458A" stopOpacity={0} />
                  </linearGradient>
                </defs>
