    ...
    <div className="max-w-5xl mx-auto pb-20">
      ...
      <form onSubmit={handleSubmit} className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2 mb-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#13458A]/30 text-sm"
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2 mb-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400/30 text-sm"
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#13458A]/30 text-sm"
          ...
          <Card className="p-6">
            <h3 className="text-lg font-bold text-gray-900 mb-4 border-b pb-2">Options</h3>
              ...
              {[15, 30, 60, 120].map(qty => (
                <div
                  ...
                  className={`border rounded-lg p-3 text-center cursor-pointer transition-all ${formData.supplementQuantityOptions.includes(qty)
                      ? "border-[#13458A] bg-blue-50 text-[#13458A] font-medium ring-1 ring-[#13458A]"
                      : "border-gray-300 text-gray-700 hover:border-[#13458A]/50"
                    }`}
                >
                  {qty} caps
                </div>
          ...
          <Card className="p-6">
            <h3 className="text-lg font-bold text-gray-900 mb-4 border-b pb-2">Images</h3>
