      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="bg-white border border-gray-200 rounded-xl px-4 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-[#13458A]/30 focus:border-[#13458A] transition hover:border-[#13458A]/40"
          >
        ...
        <div className="space-y-2 text-gray-600 text-sm">
          <p><strong className="text-gray-800">Health Benefits:</strong> {product.healthBenefits.join(", ")}</p>
          <p><strong className="text-gray-800">Ingredients:</strong> {product.ingredients.join(", ")}</p>
          <p><strong className="text-gray-800">Usage Instructions:</strong> {product.usageInstructions}</p>
        </div>
        <Button variant="primary" size="md" className="mt-4">Add to Cart</Button>
      </div>
    </div>
  )
}
