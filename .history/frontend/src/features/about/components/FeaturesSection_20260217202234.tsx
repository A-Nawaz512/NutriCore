...
const FeaturesSection: FC = () => (
  <section className="py-16 sm:py-20 bg-gray-50">
    <div className="container mx-auto px-4 sm:px-6 md:px-16 text-center">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 bg-black">
        {/* Feature 1 */}
        <div className="flex bg-blue-300 flex-col items-center transition transform hover:-translate-y-1 duration-300">
